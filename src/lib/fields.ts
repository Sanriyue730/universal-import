...
export const COLUMN_ALIASES: Record<string, string[]> = {
  externalCode: ['外部编码', '客户单号', '订单号', '订单编号', 'Order No', 'External Code', 'order_no', 'ext_code'],
  senderName: ['发件人姓名', '发件人', '寄件人', '发货人', '发方', 'Sender', 'Sender Name', 'sender_name', '寄件人姓名'],
  senderPhone: ['发件人电话', '发件人手机', '寄件人电话', '发货人电话', '发方电话', 'Sender Phone', 'Sender Tel', 'sender_phone', '寄件人手机'],
  ...
  receiverPhone: ['收件人电话', '收件人手机', '收货人电话', '收方电话', 'Receiver Phone', 'Receiver Tel', 'receiver_phone', '收货人手机'],
  receiverAddress: ['收件人地址', '收件地址', '收货地址', '收方地址', 'Receiver Address', 'receiver_address', '收货人地址'],
  weight: ['重量', '重量(kg)', '重量（kg）', '货物重量', 'Weight', 'weight', 'Weight(kg)'],
  quantity: ['件数', '数量', '包裹数', '包裹数量', 'Qty', 'Quantity', 'quantity', 'Pieces'],
  tempZone: ['温层', '温度层', '温区', '储运温层', 'Temp Zone', 'Temperature', 'temp_zone', 'Temp'],
